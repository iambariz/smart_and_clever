...
class SettingsMenu extends WatchUi.Menu2 {
    function initialize() {
        ...
        Menu2.addItem(new WatchUi.MenuItem(Rez.Strings.DesignPresetTitle, null, "Design", null));
        Menu2.addItem(new WatchUi.MenuItem(Rez.Strings.ColorSchemeTitle, null, "ColorScheme", null));
